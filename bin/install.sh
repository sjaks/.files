...
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom2/ binding '<Super><Shift>Return'exgsettings set org.gnome.settings-daemon.plugins.media-keys volume-up "['<Alt>Page_Up']"
